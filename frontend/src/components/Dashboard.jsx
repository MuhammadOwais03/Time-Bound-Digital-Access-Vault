...
// import { Lock, Plus, ChevronRight, RefreshCw } from 'lucide-react';
...
//           className="w-full mb-6 bg-purple-600 hover:bg-purple-700 text-white py-4 rounded-xl flex items-center justify-center gap-2 font-semibold transition-colors"
//         >
//           <Plus size={20} />
...
//               <h3 className="text-xl font-semibold text-white mb-2">No vault items yet</h3>
//               <p className="text-purple-300">Create your first secure vault item to get started</p>
//             </div>
//           ) : (
//             vaultItems.map((item) => (
//               <div
...
//                           {item.shareCount} share link{item.shareCount !== 1 ? 's' : ''}
//                         </span>
//                       )}
//                     </div>
//                   </div>
//                   <ChevronRight className="text-purple-400 group-hover:text-white transition-colors" size={24} />
//                 </div>
//               </div>
//             ))
//           )}
